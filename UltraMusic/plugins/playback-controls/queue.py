...
from UltraMusic import app, config, db, lang, queue
from UltraMusic.helpers import Track, buttons, command, thumb


@app.on_message(command(["القائمة"]) & filters.group & ~app.bl_users)
@lang.language()
