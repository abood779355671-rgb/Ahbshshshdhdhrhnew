...
class Config:
    ...
    def __init__(self):
        ...
        # Use the locally-generated /start welcome image (PIL, frosted-glass
        # style matching the now-playing thumbnails) instead of the external
        # START_IMG link. Default False keeps existing deployments unchanged.
        self.USE_GENERATED_START_IMG: bool = self._str_to_bool(
            getenv("USE_GENERATED_START_IMG", "False"))
